...
@section('content')
    ...
    <div class="mb-4">
        ...
        <h4 class="mb-1 fw-semibold" style="color:var(--sa-white)">
            <i class="bi bi-plus-circle text-cyan me-2"></i>Tambah Kolam Baru
        </h4>
        <p class="mb-0 small" style="color:var(--sa-medium)">Isi form di bawah untuk mendaftarkan kolam baru</p>
    </div>
        ...
        <div class="col-12 col-lg-8 col-xl-6">
            <div class="sa-glass-card">
                <div class="sa-card-body">
                    <form method="POST" action="{{ route('admin.ponds.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name"
                                   ...
                                   value="{{ old('name') }}" required placeholder="Contoh: Kolam Utama A">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="code" name="code"
                                   ...
                                   value="{{ old('code') }}" required placeholder="Contoh: POND-A1">
                            @error('code')
                                <div class="sa-invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-6">
                                ...
                                <input type="number" step="0.1" id="water_level_min" name="water_level_min"
                                       ...
                                       value="{{ old('water_level_min', 3) }}" placeholder="3">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" step="0.1" id="water_level_max" name="water_level_max"
                                       ...
                                       value="{{ old('water_level_max', 12) }}" placeholder="12">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                ...
                                <input type="number" step="0.1" id="ph_min" name="ph_min"
                                       ...
                                       value="{{ old('ph_min', 6.5) }}" placeholder="6.5">
                                @error('ph_min')
                                    <div class="sa-invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <input type="number" step="0.1" id="ph_max" name="ph_max"
                                       ...
                                       value="{{ old('ph_max', 8.5) }}" placeholder="8.5">
                                @error('ph_max')
                                    <div class="sa-invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
